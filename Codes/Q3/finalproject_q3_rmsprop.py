# -*- coding: utf-8 -*-
"""FinalProject Q3-RMSprop

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ilsjN_1bknvQWdzhpf0DbKGuxkWHxwMT
...
for lr in learning_rates:
  for epoch in epochs:
        print(f"Training CNN with RMSprop: learning rate: {lr}, epochs: {epoch}")
        ...
        # Compile the model
        CNN.compile(optimizer = optimizers.RMSprop(learning_rate=lr),loss='binary_crossentropy', metrics=['accuracy'])
...
precision, recall, thresholds = precision_recall_curve(test_label,predicted_labels)

# Initialize lists to store precision, recall, and threshold values
precision_values = []
recall_values = []
...
plt.figure(figsize=(8, 6))
plt.plot(precision_values, recall_values,precision_values,recall_values,'ro')
