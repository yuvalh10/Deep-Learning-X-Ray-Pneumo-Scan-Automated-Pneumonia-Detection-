# -*- coding: utf-8 -*-
"""FinalProject Q3-SGD with momentum

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1V3YUqjIDoVdDfZGKLr8KjtLw5T2SFbUg
...
for lr in learning_rates:
  for epoch in epochs:
        print(f"Training CNN with SGD,with momentum: learning rate: {lr}, epochs: {epoch}")
        ...
        plt.title(f'Training and Validation Accuracy vs. Number of Epochs\nOptimizer: Optimizer:SGD (with momentum), Learning Rate: {lr}, Epochs: {epoch}')
        plt.xlabel('Epochs')
        plt.ylabel('Accuracy')
        plt.grid()
