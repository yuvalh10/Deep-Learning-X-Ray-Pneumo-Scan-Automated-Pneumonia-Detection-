# -*- coding: utf-8 -*-
"""FinalProject Q3-SGD with momentum-Early Stopping

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15ykFRzrodfZvS5zV8nMiJrIhF21YQXAf
...
# Build the model
# 96.5% - best prefomance for RMSprop with 0.01 lr
epochs = 20
lr = 0.001

print(f"Training CNN with RMSprop: learning rate: {lr}, epochs: {epochs}")
...
# Compile the model
CNN.compile(optimizer = optimizers.SGD(learning_rate=lr,momentum=0.9),loss='binary_crossentropy', metrics=['accuracy'])
...
history = CNN.fit(train_norm, train_label, epochs = epochs, batch_size = 20,
